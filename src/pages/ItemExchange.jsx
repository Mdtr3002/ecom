    ...
    <div key={index} className="col-12 col-sm-6 col-lg-4 col-xl-3">
      <div className="item-card card shadow-sm">
        <div className="card-body">
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    navigator.clipboard.writeText(
                      `${API}collection/bidding/${itemTypeId}/${elem._id}`
                    );
          ...
          <div className="row gx-2 align-items-center mt-3">
            <h5 className="text-truncate" style={{ marginBottom: 0 }}>
              {elem?.itemId?.name}{" "}
              <img
                className="me-1"
        ...
        <div className="row">
          <div className="col-12 col-sm-9 col-lg-6">
            <div className="section-heading">
              ...
              <p>
                <img
                  src={`${process.env.PUBLIC_URL}/img/core-img/ethereum.png`}
                  alt=""
                />
                Participate in bidding for valuable items
              </p>
            </div>
          </div>
        </div>
