                ...
                <div className="col-12 col-sm-6 col-xl-4">
                    <div className="single-process-card card bg-gray border-0">
                      <div className="card-body p-4 text-center">
                        ...
                        <p style={{ color: "#C2D4F8" }} className="mb-0">
                          1. 10% higher than the current price
                        </p>
                        <p style={{ color: "#C2D4F8" }} className="mb-0">
                          2. Lower or equal to the highest price
                        </p>
                        <p style={{ color: "#C2D4F8" }} className="mb-0">
                          3. Affordable with your GCoin balance
                        </p>
                      </div>
                ...
                <div className="col-12 col-sm-6 col-xl-4">
                    <div className="single-process-card card bg-gray border-0">
                      <div className="card-body p-4 text-center">
                        ...
                        <p style={{ color: "#C2D4F8" }} className="mb-0">
                          Become the first player to bid the highest price. If
                          not, the highest bidder when the auction period ends
                        </p>
                      </div>
                ...
                <div className="col-12 col-sm-6 col-xl-4">
                    <div className="single-process-card card bg-gray border-0">
                      <div className="card-body p-4 text-center">
                        ...
                        <p className="mb-0" style={{ color: "#C2D4F8" }}>
                          ● If won, you can claim the item
                        </p>
                        <p className="mb-0" style={{ color: "#C2D4F8" }}>
                          ● If lost, your GCoin will be refunded
                        </p>
                      </div>
              ...
              <div className="card border-0 shadow-sm dashboard-responsive">
                ...
                >
                  ...
                  <p style={{ color: "white" }}>
                    ...
                    <b style={{ color: "yellow" }}> GCoins</b> in accordance
                    with our bidding rules
                  </p>
                  <img
                    src={bidDemo3}
                    alt="Place Bid demo"
              ...
              <div className="card border-0 shadow-sm dashboard-responsive">
                ...
                >
                  ...
                  <p style={{ color: "white" }}>
                    ...
                    <Link to="/my-bids">
                      <u style={{ color: "yellow" }}> My Bids</u>
                    </Link>{" "}
                    page
                  </p>
                  <img
