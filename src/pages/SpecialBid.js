                ...
                <div className="d-flex flex-column-reverse flex-md-row g-4 g-lg-5 align-items-center justify-content-between">
                    <div className="col-12 col-md-6 col-xl-5">
                        <div className="register-card">
                            ...
                            <p style={{color: 'white', whiteSpace: "pre-line", fontSize: '20px'}}>
                                <b>Stay tuned</b> for occasionally held<b style={{color: 'yellow'}}> GCoins</b> auctions where players will compete for chances to own <b style={{color: 'yellow'}}>limited exclusive Items</b>.
                            </p>
                        </div>
                    </div>
