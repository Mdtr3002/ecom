...
const DiscoverAllBidItem = () => {
    ...
    useEffect(() => {
        MarketPlaceServices.getAllBids().then((res) => setBidItems(res.data.payload));
    }, [])
                    ...
                    <div className="row gx-2 align-items-center mt-2">
                        ...
                        <div className="col-4">
                            <div className="price text-end">
                                ...
                                <h6 className="mb-0">{elem.minPrice}</h6>
                            </div>
                        </div>
...
export default DiscoverAllBidItem;
